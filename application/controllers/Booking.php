...
class Booking extends CI_Controller
{
 ...
 if ($databooking > 0) {
     $this->session->set_flashdata('pesan', '<div class="alert alert￾danger alert￾message" role="alert">Masih Ada booking buku sebelumnya yang belum diambil.<br> Ail Buku yang dibooking atau tunggu 1x24 Jam untuk bisa booking kembali </div>') ;
 redirect(base_url());
}
...
//membuat tabel temp jika belum ada
 ...
 //mengupdate stok dan dibooking di tabel buku saat proses booking diselesaikan
        $this->db->query("UPDATE buku, temp SET buku.dibooking=buku.dibooking+1, buku.stok=buku.stok-1 
 ...
 //menyimpan ke tabel booking dan detail booking, dan mengosongkan tabel temporari
    ...
    public function exportToPdf()
    {
        ...
        include $root = '/xampp/htdocs/pustaka-booking/application/third_party/dompdf/autoload.inc.php';
